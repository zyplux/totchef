...
def test_11_1_1_chezmoi_clones_the_repo_into_the_source_dir(recipe, system, terminal, totchef):
...
def test_11_1_2_source_dir_is_configurable_and_written_to_chezmoi_config(recipe, system, terminal, totchef, home):
...
def test_11_1_3_chezmoi_is_idempotent_once_provisioned(recipe, system, terminal, totchef, home):
...
def test_11_2_1_chezmoi_is_user_scoped_not_root(cli):
...
def test_11_2_2_chezmoi_without_the_binary_fails_clearly(recipe, totchef):
...
def test_11_3_1_auto_commit_and_push_are_on_and_written_to_chezmoi_git_config(recipe, system, totchef, home):
...
def test_11_3_2_capture_units_install_and_the_timer_is_enabled(recipe, system, terminal, totchef, home):
...
def test_11_3_3_capture_is_idempotent_once_enabled(recipe, system, terminal, totchef, home):
...
def test_11_3_4_timer_cadence_comes_from_timer_min(recipe, system, totchef, home):
...
def test_11_3_5_timer_min_must_be_positive(recipe, totchef):
